...
public class LoanUnitQueryFindApprovedEndpoint {
    ...
    public LoanUnitQueryFindApprovedEndpoint(RuleUnit<org.acme.kogito.queries.LoanUnit> ruleUnit) {
    ...
    public List<org.acme.kogito.model.LoanApplication> executeQuery(org.acme.kogito.queries.LoanUnit unitDTO) {
        ...
        List<org.acme.kogito.model.LoanApplication> response = instance.executeQuery(LoanUnitQueryFindApproved.class);
        instance.dispose();
        return response;
    }
