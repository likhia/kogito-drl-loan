...
public class LoanUnitQueryFindAll implements org.kie.kogito.rules.RuleUnitQuery<List<org.acme.kogito.model.LoanApplication>> {

    private final RuleUnitInstance<org.acme.kogito.queries.LoanUnit> instance;

    public LoanUnitQueryFindAll(RuleUnitInstance<org.acme.kogito.queries.LoanUnit> instance) {
        this.instance = instance;
    }

    @Override
    public List<org.acme.kogito.model.LoanApplication> execute() {
        return instance.executeQuery("FindAll").stream().map(this::toResult).collect(toList());
    }
